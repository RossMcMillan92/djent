  ...
  kieranMode &&
    {
        ...
        load: promiseToTask(() => import(/* webpackChunkName: "presets.kieran" */ './presets/kieran'))
    },
].filter(Boolean)

const initialPreset = kieranMode
  ? 'kieran'
  : 'meshuggah'
  console.log('INITIALPRESET', initialPreset)
